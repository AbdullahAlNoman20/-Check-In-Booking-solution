		...
		<div className="grid gap-4 mx-4 sm:grid-cols-12">
			<div className="col-span-12 sm:col-span-3">
				<div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:dark:bg-violet-600">
					...
					<span className="text-sm font-bold tracking-wider uppercase dark:text-gray-600">Embark on a journey with Check-In, where exceptional hospitality, dedication to quality, and a commitment to sustainability and community define every stay.</span>
				</div>
			</div>
...
<section className="dark:bg-gray-100 dark:text-gray-800 mt-10">
	<div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
		...
		<p className="mt-4 mb-8 dark:text-gray-600">Find quick answers to your most pressing questions about Check-In's services, facilities, and policies, ensuring a hassle-free experience.</p>
