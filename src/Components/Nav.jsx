...
<div className="navbar">
  <div className="navbar-start">
    ...
    <a className="text-xl lg:text-5xl lg:font-bold" data-aos="zoom-in" data-aos-duration="2000"><i className="fa-solid fa-building-circle-check text-yellow-500"></i> Check<span className="text-yellow-500">-In</span></a>
  </div>
  ...
  <div className="avatar flex items-center justify-end gap-2">
            ...
            <NavLink to="/login">
            <button className="btn btn-outline btn-error hidden lg:block ">
